...
(function () {
    ...
    app.controller('AnomalyAPIController', function ($scope, $http) {
        ...
        /*
         This is for filling in the Data Type drop down. 
        The data type is the data set like (weight/height) etc
        */
     //This is to get all data types from the database
        ...
        //This is to get 2 Dimensional data types from the database
        ...
        //This is to get 3 Dimensional data types from the database
        ...
        $scope.ShowOnGraph = function (DataTypeid) {
            ...
            var uri = m_SvcUri + "/ADClusteredData/" + DataTypeid + "/" + fileName;
        ...
        $scope.queryClusterDetail = function () {
            ...
            fileName = fil.name.replace(".json", "");
            uri = m_SvcUri + "/ADClusteredData/" + DataTypeid + "/" + fileName;
            $http.get(uri)
            .success(function (data) {
                for (i = 0; i < data.length; i++) {
                    clusters.push({ClusterId:i});
                    cluster_detail.push({ClusterId:i,centroid:data[i].Centroid, ClusterDataDistanceToCentroid:data[i].ClusterDataDistanceToCentroid,
