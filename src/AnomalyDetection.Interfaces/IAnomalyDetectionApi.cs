...
namespace AnomalyDetection.Interfaces
{
...

    {
        ...
        /// </ul>
        /// </returns>
        AnomalyDetectionResponse GetResults(SaveLoadSettings LoadSettings, out ClusteringResults[] Result);
        ...
        /// </ul>
        /// </returns>
        AnomalyDetectionResponse RecommendedNumberOfClusters(double[][] RawData, int KmeansMaxIterations, int NumberOfAttributes, int MaxNumberOfClusters, int MinNumberOfClusters, int Method, double[] StdDev, out int RecNumberOfClusters, int KmeansAlgorithm = 1);
    }
}
